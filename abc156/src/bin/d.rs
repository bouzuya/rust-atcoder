...
fn choose(n: usize, r: usize) -> ModU32 {
    let mut a = ModU32::from(n);
    let mut b = ModU32::from(r);
    for i in 1..r {
        a *= ModU32::from(n - i);
        b *= ModU32::from(i);
    }
...
fn main() {
    ...
    let u = ModU32::new(2).pow(n as u32) - ModU32::new(1);
    let ans = u - choose(n, a) - choose(n, b);
    println!("{}", ans);
}
